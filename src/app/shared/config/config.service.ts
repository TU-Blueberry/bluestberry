...
export class ConfigService {
 ...
 // TODO: Wo kriege ich tabs, die gerade offen sind, her?
 // TODO: Muss noch abspeichern, ob terminal gerade offen
 ...
 public updateTabsAndSizes(exp: Experience, settings: Map<string, SplitAreaSettings>, open: { path: string, on: string }[]) {
