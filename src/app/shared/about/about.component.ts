...
export class AboutComponent implements OnInit {
  icons: Icons[] = [
    { path: 'dictionary', name: 'Freepik', url: 'https://www.freepik.com" title="Freepik>'},
    { path: 'experiment', name: 'Prosymbols', url: 'https://www.flaticon.com/authors/prosymbols'},
    { path: 'industrial-robot', name: 'Freepik', url: 'https://www.freepik.com" title="Freepik>'},
    ...
    { path: 'plaintext', name: 'Freepik', url: 'https://www.freepik.com" title="Freepik>'},
