...
import { HeroChip, HeroDocument, HeroDocumentText, HeroPhotograph, HeroX, HeroBookOpen } from '@ng-icons/heroicons';
...
@NgModule({
  ...
  imports: [
    ...
    UnityModule,
    HttpClientModule,
    NgIconsModule.withIcons({ HeroDocumentText, HeroDocument, HeroX, HeroPhotograph, HeroChip, HeroBookOpen }),
